...
import controller.TransactionCategoriController;
 ...
 * @author Leonovo
 */
public class MasterTransactionCategori extends javax.swing.JFrame {

    TransactionCategoriController categoryCtr;
    DefaultTableModel tableModel;
    /**
     * Creates new form MasterUserForm
     */
    public MasterTransactionCategori() {
        categoryCtr = new TransactionCategoriController();
    ...
    private void loadDataTable() {
        ...
        try {
            ...
            List<TransactionCategori> listCategory = categoryCtr.getData(cariData);
            Object[] colums = {"Category ID", "Nama", "Account ID", "Type", "Description","Aksi"};
            tableModel.setColumnIdentifiers(colums);
            
            for (TransactionCategori category : listCategory) {
    ...
    private void showDataToForm(String categoryId) {
        try {
            TransactionCategori category = categoryCtr.getTransactionCategoryById(categoryId);
            ...
            txtAccountID.setText(category.getAccountId());
            txtType.setSelectedItem(category.getType());
    ...
    private void save() {
        ...
        category.setAccountId(txtAccountID.getText());
        category.setType(txtType.getSelectedItem().toString());
    ...
    private void resetForm() {
        ...
        lblTitleForm.setText("Form Tambah Data Category");
    }
    ...
    private void initComponents() {
        ...
        txtType = new components.RoundedComboBox();
        ...
        txtType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "debit", "kredit" }));
        txtType.setMaximumSize(new java.awt.Dimension(2147483647, 2147483647));
        txtType.setPreferredSize(new java.awt.Dimension(25, 33));
                            ...
                            .addGroup(roundedPanel1Layout.createSequentialGroup()
                                .addGroup(roundedPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(roundedPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(12, 12, 12)
                                        .addComponent(txtCategoriID, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(roundedPanel1Layout.createSequentialGroup()
        ...
        txtType.getAccessibleContext().setAccessibleName("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterTransactionCategori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MasterTransactionCategori().setVisible(true);
            }
        });
    }
    ...
    private components.RoundedComboBox txtType;
