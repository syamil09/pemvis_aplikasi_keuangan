 ...
 * @author Leonovo
 */
public class PopupChooseAccount extends javax.swing.JFrame {
     ...
     */
    public PopupChooseAccount(OnAccountSelectedCallback callback) {
     ...
     */
    public static PopupChooseAccount show(OnAccountSelectedCallback callback) {
        PopupChooseAccount popup = new PopupChooseAccount(callback);
     ...
     * @return instance PopupChooseAccount
     */
    public static PopupChooseAccount show(JFrame parent, OnAccountSelectedCallback callback) {
        PopupChooseAccount popup = new PopupChooseAccount(callback);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupChooseAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupChooseAccount().setVisible(true);
            }
        });
    }
