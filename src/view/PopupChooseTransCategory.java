 ...
 * @author Leonovo
 */
public class PopupChooseTransCategory extends javax.swing.JFrame {

    TransactionCategoryController projectCtr;
    DefaultTableModel tableModel;
    /**
     * Creates new form PopupChooseAccount
     */
    public PopupChooseTransCategory() {
        projectCtr = new TransactionCategoryController();
    ...
    public interface OnDataSelectedCallback {
        void onDataSelected(TransactionCategory project);
    }
     ...
     */
    public PopupChooseTransCategory(OnDataSelectedCallback callback) {
     ...
     */
    public static PopupChooseTransCategory show(OnDataSelectedCallback callback) {
        PopupChooseTransCategory popup = new PopupChooseTransCategory(callback);
     ...
     * @return instance PopupChooseAccount
     */
    public static PopupChooseTransCategory show(JFrame parent, OnDataSelectedCallback callback) {
        PopupChooseTransCategory popup = new PopupChooseTransCategory(callback);
    ...
    private void setupFrame() {
        setTitle("Pilih Kategori Transaksi");
    ...
    private void loadDataTable() {
        ...
        try {
            ...
            List<TransactionCategory> listCategory = projectCtr.getData(cariData);
    ...
    private void selectAccount(int row, Object[] rowData) {
        try {
            ...
            TransactionCategory project = projectCtr.getTransactionCategoryById(projectId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupChooseTransCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupChooseTransCategory().setVisible(true);
            }
        });
    }
